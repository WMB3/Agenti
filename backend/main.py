...
# Need a gemini client and models config to mimic the prompt's issue.
...
async def analyze_vehicle(car: CarData):
    ...
    prompt = f"Analyze this vehicle: {car.year} {car.make} {car.model}"
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to analyze vehicle")
